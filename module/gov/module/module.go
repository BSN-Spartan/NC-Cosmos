...
import (
	...
	"github.com/bianjieai/spartan-cosmos/module/gov/keeper"
)
...
func (am AppModule) Route() sdk.Route {
	return sdk.NewRoute(types.RouterKey, gov.NewHandler(am.keeper.Keeper))
}
...
func (am AppModule) LegacyQuerierHandler(legacyQuerierCdc *codec.LegacyAmino) sdk.Querier {
	return govkeeper.NewQuerier(am.keeper.Keeper, legacyQuerierCdc)
}

// RegisterServices registers module services.
func (am AppModule) RegisterServices(cfg module.Configurator) {
	types.RegisterMsgServer(cfg.MsgServer(), govkeeper.NewMsgServerImpl(am.keeper.Keeper))
...
func (am AppModule) ExportGenesis(ctx sdk.Context, cdc codec.JSONCodec) json.RawMessage {
	gs := gov.ExportGenesis(ctx, am.keeper.Keeper)
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	return simulation.WeightedOperations(
		...
		am.accountKeeper, am.bankKeeper, am.keeper.Keeper, simState.Contents,
	)
}
