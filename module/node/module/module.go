...
func (AppModuleBasic) ValidateGenesis(cdc codec.JSONCodec, config client.TxEncodingConfig, bz json.RawMessage) error {
	...
	return node.ValidateGenesis(data)
}
...
type AppModule struct {
	...
	k spartannodekeeper.Keeper
}

// NewAppModule creates a new AppModule object
func NewAppModule(cdc codec.Codec, keeper spartannodekeeper.Keeper) AppModule {
	return AppModule{
...
func (am AppModule) RegisterServices(cfg module.Configurator) {
	...
	types.RegisterQueryServer(cfg.QueryServer(), keeper.Querier{Keeper: am.k.Keeper})
}
...
func (am AppModule) Route() sdk.Route {
	return sdk.NewRoute(types.RouterKey, nil) //TODO
}
...
func (am AppModule) LegacyQuerierHandler(legacyQuerierCdc *codec.LegacyAmino) sdk.Querier {
	return keeper.NewQuerier(am.k.Keeper, legacyQuerierCdc)
}
